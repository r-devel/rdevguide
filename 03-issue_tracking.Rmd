...
1. [Reporting bugs](https://contributor.r-project.org/rdevguide/ReportingBugs.html) or making feature requests (bug reports filed under the "Wishlist" component in Bugzilla),
