...
\NormalTok{      bash{-}completion }\DataTypeTok{\textbackslash{}}
\NormalTok{      bison }\DataTypeTok{\textbackslash{}}
\NormalTok{      debhelper{-}compat }\DataTypeTok{\textbackslash{}}
\NormalTok{      default{-}jdk }\DataTypeTok{\textbackslash{}}
\NormalTok{      g++ }\DataTypeTok{\textbackslash{}}
\NormalTok{      gcc }\DataTypeTok{\textbackslash{}}
\NormalTok{      gfortran }\DataTypeTok{\textbackslash{}}
\NormalTok{      groff{-}base }\DataTypeTok{\textbackslash{}}
\NormalTok{      libblas{-}dev }\DataTypeTok{\textbackslash{}}
\NormalTok{      libbz2{-}dev }\DataTypeTok{\textbackslash{}}
\NormalTok{      libcairo2{-}dev }\DataTypeTok{\textbackslash{}}
\NormalTok{      libcurl4{-}dev }\DataTypeTok{\textbackslash{}}
\NormalTok{      libcurl4{-}openssl{-}dev }\DataTypeTok{\textbackslash{}}
\NormalTok{      libjpeg{-}dev }\DataTypeTok{\textbackslash{}}
\NormalTok{      liblapack{-}dev }\DataTypeTok{\textbackslash{}}
\NormalTok{      liblzma{-}dev }\DataTypeTok{\textbackslash{}}
\NormalTok{      libncurses5{-}dev }\DataTypeTok{\textbackslash{}}
\NormalTok{      libpango1.0{-}dev }\DataTypeTok{\textbackslash{}}
\NormalTok{      libpcre2{-}dev }\DataTypeTok{\textbackslash{}}
\NormalTok{      libpcre3{-}dev }\DataTypeTok{\textbackslash{}}
...
\NormalTok{      libx11{-}dev }\DataTypeTok{\textbackslash{}}
\NormalTok{      libxt{-}dev }\DataTypeTok{\textbackslash{}}
\NormalTok{      mpack }\DataTypeTok{\textbackslash{}}
\NormalTok{      rsync }\DataTypeTok{\textbackslash{}}
\NormalTok{      tcl8.6{-}dev }\DataTypeTok{\textbackslash{}}
\NormalTok{      texinfo }\DataTypeTok{\textbackslash{}}
\NormalTok{      texlive{-}base }\DataTypeTok{\textbackslash{}}
\NormalTok{      texlive{-}extra{-}utils }\DataTypeTok{\textbackslash{}}
\NormalTok{      texlive{-}fonts{-}extra }\DataTypeTok{\textbackslash{}}
\NormalTok{      texlive{-}fonts{-}recommended }\DataTypeTok{\textbackslash{}}
\NormalTok{      texlive{-}latex{-}base }\DataTypeTok{\textbackslash{}}
\NormalTok{      texlive{-}latex{-}extra }\DataTypeTok{\textbackslash{}}
\NormalTok{      texlive{-}latex{-}recommended }\DataTypeTok{\textbackslash{}}
\NormalTok{      texlive{-}plain{-}generic }\DataTypeTok{\textbackslash{}}
\NormalTok{      tk8.6{-}dev }\DataTypeTok{\textbackslash{}}
\NormalTok{      x11proto{-}core{-}dev }\DataTypeTok{\textbackslash{}}
\NormalTok{      xauth }\DataTypeTok{\textbackslash{}}
\NormalTok{      xdg{-}utils }\DataTypeTok{\textbackslash{}}
\NormalTok{      xfonts{-}base }\DataTypeTok{\textbackslash{}}
\NormalTok{      xvfb }\DataTypeTok{\textbackslash{}}
\NormalTok{      zlib1g{-}dev }
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    autoconf }\DataTypeTok{\textbackslash{}}
\NormalTok{    automake }\DataTypeTok{\textbackslash{}}
\NormalTok{    bzip2{-}devel }\DataTypeTok{\textbackslash{}}
\NormalTok{    cairo{-}devel }\DataTypeTok{\textbackslash{}}
\NormalTok{    flexiblas{-}devel }\DataTypeTok{\textbackslash{}}
\NormalTok{    gcc{-}c++ }\DataTypeTok{\textbackslash{}}
\NormalTok{    gcc{-}gfortran }\DataTypeTok{\textbackslash{}}
\NormalTok{    java{-}devel }\DataTypeTok{\textbackslash{}}
\NormalTok{    less }\DataTypeTok{\textbackslash{}}
\NormalTok{    libICE{-}devel }\DataTypeTok{\textbackslash{}}
\NormalTok{    libSM{-}devel }\DataTypeTok{\textbackslash{}}
\NormalTok{    libX11{-}devel }\DataTypeTok{\textbackslash{}}
\NormalTok{    libXmu{-}devel }\DataTypeTok{\textbackslash{}}
\NormalTok{    libXt{-}devel }\DataTypeTok{\textbackslash{}}
\NormalTok{    libcurl{-}devel }\DataTypeTok{\textbackslash{}}
\NormalTok{    libicu{-}devel }\DataTypeTok{\textbackslash{}}
\NormalTok{    libjpeg{-}devel }\DataTypeTok{\textbackslash{}}
\NormalTok{    libpng{-}devel }\DataTypeTok{\textbackslash{}}
\NormalTok{    libtiff{-}devel }\DataTypeTok{\textbackslash{}}
\NormalTok{    libtool }\DataTypeTok{\textbackslash{}}
\NormalTok{    ncurses{-}devel }\DataTypeTok{\textbackslash{}}
\NormalTok{    pango{-}devel }\DataTypeTok{\textbackslash{}}
\NormalTok{    pcre2{-}devel }\DataTypeTok{\textbackslash{}}
\NormalTok{    readline{-}devel }\DataTypeTok{\textbackslash{}}
\NormalTok{    rsync }\DataTypeTok{\textbackslash{}}
\NormalTok{    tcl{-}devel }\DataTypeTok{\textbackslash{}}
    \StringTok{\textquotesingle{}tex(inconsolata.sty)\textquotesingle{}} \DataTypeTok{\textbackslash{}}
    \StringTok{\textquotesingle{}tex(latex)\textquotesingle{}} \DataTypeTok{\textbackslash{}}
    \StringTok{\textquotesingle{}tex(upquote.sty)\textquotesingle{}} \DataTypeTok{\textbackslash{}}
\NormalTok{    texinfo{-}tex }\DataTypeTok{\textbackslash{}}
\NormalTok{    tk{-}devel }\DataTypeTok{\textbackslash{}}
\NormalTok{    tre{-}devel }\DataTypeTok{\textbackslash{}}
\NormalTok{    valgrind{-}devel }\DataTypeTok{\textbackslash{}}
\NormalTok{    xz{-}devel }\DataTypeTok{\textbackslash{}}
\NormalTok{    zlib{-}devel}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\BuiltInTok{export} \VariableTok{RSTUIDO\_WHICH\_R}\OperatorTok{=}\StringTok{"}\VariableTok{$BUILDDIR}\StringTok{/bin/R"}
\BuiltInTok{cd} \StringTok{"}\VariableTok{$TOP\_SRCDIR}\StringTok{"}
...
\subsubsection{From source}\label{from-source}}
...
\begin{Highlighting}[]
\BuiltInTok{cd} \StringTok{"}\VariableTok{$TOP\_SRCDIR}\StringTok{"}
\FunctionTok{wget} \AttributeTok{{-}np} \AttributeTok{{-}nd} \AttributeTok{{-}r} \AttributeTok{{-}l1} \AttributeTok{{-}A} \StringTok{\textquotesingle{}tcltk{-}*.zip\textquotesingle{}}\NormalTok{ https://cran.r{-}project.org/bin/windows/Rtools/rtools42/files/}
...
\BuiltInTok{export} \VariableTok{PATH}\OperatorTok{=}\StringTok{"/c/Program\textbackslash{} Files/MiKTeX/miktex/bin/x64:}\VariableTok{$PATH}\StringTok{"}
