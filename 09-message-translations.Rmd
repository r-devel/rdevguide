...
**Note:** A detailed conventions and workflow for translation is given
here:
[Conventions-for-translations](https://github.com/r-devel/translations/wiki/Conventions-for-translations){.uri}
...
If you are confident that the translation is correct, make sure the
"Needs editing" box is unchecked.

If you are unsure, leave the "Needs editing" box checked. This marks the
translation as "fuzzy" and although it may be added to the R source
files, the translation will **not** be used.

Finally, Click "Save and Continue" to save the translation and continue.

**Note:** Make sure to use Automatic Suggestions (machine translation)
as a starting point.

1.  Click on Automatic Suggestions
...
-   Check for technical issues: After finishing the translation, check
    if you have any alerts or warning in the Weblate string status, e.g.
    double instead of single space.

-   Follow langugage specific guidelines: Check how other languages have
    translated the string. Even if you are not fluent in another
...
-   Use Glossary feature within Weblate:
