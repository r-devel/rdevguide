...
If you are unsure, leave the "Needs editing" box checked. This marks the translation as "fuzzy" and although it may be added to the R source files, the translation will **not** be used. 
...
# - Use Automatic Suggestions (machine translation) as a starting point (this may need more than a bullet point to explain how to do this)
...
- See Glossary feature within Weblate: https://translate.rx.studio/projects/r-project/glossary/
