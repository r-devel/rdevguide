...
You should modify the source code on your computer of the latest version of R (`r-devel`). You can retrieve the latest source code of R via:

  ```sh
  export TOP_SRCDIR="$HOME/Downloads/R"
  svn checkout https://svn.r-project.org/R/trunk/ "$TOP_SRCDIR"
  ```
Then you should edit the files, for example a documentation file such as  `"$TOP_SRCDIR"/src/library/stats/man/Multinom.Rd`. 
Make your desired changes to that or more files.
