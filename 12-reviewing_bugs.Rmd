...
Relevant details should be a part of a good bug report. You can help with the following tasks once you have some experience developing for $\textsf{R}$:
...
2. Checking different binary builds: Check whether the bug occurs on a different binary build of $\textsf{R}$. It is helpful to know whether the bug is affecting: `r-patched`, `r-devel`, or `r-release` binary builds of $\textsf{R}$.
