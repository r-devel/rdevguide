...
The R Core Team also maintain a selection of websites that each have their own ways for reporting issues outside of Bugzilla. Have a read through their [posting guide](https://www.r-project.org/posting-guide.html#which_list) and then follow the instructions below to give feedback to the maintainers.

- [R FAQ](https://cran.r-project.org/doc/FAQ/R-FAQ.html) contains answers to some of the most frequently asked questions about R. Feedback on this site should be sent to the [R-devel mailing list](https://stat.ethz.ch/mailman/listinfo/r-devel) via [R-devel@R-project.org](mailto:R-devel@R-project.org).
- [R for Windows FAQ](https://cran.r-project.org/bin/windows/base/rw-FAQ.html) contains answers specific to the Windows port of R. Feedback on this FAQ site should be sent to the [R-SIG-windows mailing list](https://stat.ethz.ch/mailman/listinfo/r-sig-windows) (the Special Interest Group for Windows), via [R-windows@R-project.org](mailto:R-windows@R-project.org).
- [R for macOS FAQ](https://cran.r-project.org/bin/macosx/RMacOSX-FAQ.html) contains a user guide to the R.APP version of R and information on using R on macOS, supplementing the main R manuals. Feedback on this FAQ site should be sent to the [R-SIG-Mac mailing list](https://stat.ethz.ch/mailman/listinfo/r-sig-mac) (the Special Interest Group for Mac ports of R), via [r-sig-mac@r-project.org](mailto:r-sig-mac@r-project.org).
...
- Feedback on the website for [The Comprehensive R Archive Network](https://cran.r-project.org/) should be sent to [cran-sysadmin@r-project.org](mailto:cran-sysadmin@r-project.org).
