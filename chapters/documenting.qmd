...
* **Compiling:** To see how your changes look, you can "compile" them into PDF or HTML using tools like `makeinfo` or `texi2any` (both part of the [GNU Texinfo distribution](https://www.gnu.org/software/texinfo/manual/texinfo/)).
