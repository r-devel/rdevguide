...
- Use concise language: This will ensure the translated messages are short and easy to read

- Review the translations: After finishing the translation, check if you have any alerts or warning in the weblate string status.
