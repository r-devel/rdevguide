...
2. [R manuals](https://cran.r-project.org/manuals.html): These are a part of the [R sources](https://github.com/r-devel/r-svn/tree/master/doc/manual). Hence, bug reports/patches can also be submitted via Bugzilla, e.g. https://bugs.r-project.org/bugzilla/show_bug.cgi?id=15221. Note that they are typically referred to by their file names "R-admin", "R-exts" etc. The manuals are written in [Texinfo](https://www.gnu.org/software/texinfo/) (file extension `.texi`). The manual should be referred to for [how to mark up text](https://www.gnu.org/software/texinfo/manual/texinfo/texinfo.html). 
