...
The relevant info is: you can directly search for docs issues on Bugzilla + maybe a link to such a view. Using Bugzilla teminology such as "component" and explaining that this is a piece of metadata attached to each bug report is besides the point. Just my 2 ¢...
